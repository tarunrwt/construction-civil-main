        ...
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="overview">
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                <Card>
                  ...
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                      <AreaChart data={reports.length > 0 ? reports.slice().reverse().map((report) => ({
                        ...
                        <XAxis dataKey="date" />
                        <YAxis />
                        <Tooltip formatter={(value: number) => [`₹${value.toLocaleString('en-IN')}`, 'Cost']} />
                ...
                <Card>
                  <CardHeader><CardTitle>Manpower vs Cost</CardTitle></CardHeader>
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                      <ScatterChart data={reports.length > 0 ? reports.map(report => ({
                        ...
                        <Tooltip formatter={(value: number, name: string) => [name === 'cost' ? `₹${value.toLocaleString('en-IN')}` : value, name]} />
