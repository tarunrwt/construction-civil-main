...
-- This script creates the exact database structure that matches your application
...
-- 1. Create projects table (matches your application)
...
-- 2. Create daily_reports table (EXACTLY matching your application)
CREATE TABLE daily_reports (
    ...
    weather VARCHAR(100),
    manpower_count INTEGER,  -- Renamed to match application code
    machinery_used TEXT,    -- Renamed from 'machinery' to match application code
    work_completed TEXT,
    materials_used TEXT,    -- Renamed from 'material_used' to match application code
    safety_incidents TEXT,  -- Added to match application code
    remarks TEXT,           -- Added to match application code
    stage VARCHAR(100),
    floor VARCHAR(20),
    cost DECIMAL(10,2),
