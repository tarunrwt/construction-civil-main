...
-- This script creates all tables, indexes, policies, and functions needed for the construction management app
...
CREATE INDEX IF NOT EXISTS idx_user_project_assignments_role_id ON user_project_assignments(role_id);
